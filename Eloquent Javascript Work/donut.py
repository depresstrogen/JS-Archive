...
colors = [colorama.Fore.LIGHTRED_EX, colorama.Fore.RED, colorama.Fore.LIGHTYELLOW_EX, colorama.Fore.YELLOW, colorama.Fore.LIGHTGREEN_EX, colorama.Fore.GREEN, colorama.Fore.LIGHTCYAN_EX, colorama.Fore.CYAN, colorama.Fore.LIGHTBLUE_EX, colorama.Fore.BLUE, colorama.Fore.LIGHTMAGENTA_EX, colorama.Fore.MAGENTA, colorama.Fore.WHITE]
color_counter = 0
counter = 0
...
if __name__ == "__main__":
    for _ in range(screen_size * screen_size):
        while True:
            ...
            if color_counter == 12:
                color_counter = 0
            print(colorama.Fore.WHITE, color_counter, "\n",counter)
            print("\x1b[H" + colors[round(color_counter)])
            time.sleep(0.03125)
